            ...
            <div className=' w-full'>
                <div className='w-full flex gap-4 justify-between max-[990px]:block'>
                    <div className='max-w-[700px]'>
                        <Text className={`text-white font-bold text-base`}>درباره ما</Text>
                        <Text style={{
                                display: '-webkit-box',
                        ...
                        <ul className='grid gap-[18px]'>
                            <li className='flex gap-4'>
                                ...
                                <div>
                                    ...
                                    <Text>{getData?.address === "" ? 'ناموجود' : getData?.address}</Text>
                                </div>
                            </li>
                            <li className='flex gap-4'>
                                <AvatarButtonHeader
                                ...
                                <div>
                                    ...
                                    <Text>{getData?.support_phone === null ? 'ناموجود' : getData?.support_phone}</Text>
                                </div>
                            </li>
                            <li className='flex gap-4'>
                                <AvatarButtonHeader
                                ...
                                <div>
                                    ...
                                    <Text>{getData?.whatsApp === null ? 'ناموجود' : getData?.whatsApp}</Text>
                                </div>
                            </li>
                            <li className='flex gap-4'>
                                <AvatarButtonHeader
                                ...
                                <div>
                                    ...
                                    <Text>{getData?.telegram === null ? 'ناموجود' : getData?.telegram}</Text>
                                </div>
                            </li>
                             <li className='flex gap-4'>
                                <AvatarButtonHeader
                                ...
                                <div>
                                    ...
                                    <Text>{getData?.instagram === null ? 'ناموجود' : getData?.instagram}</Text>
                                </div>
                            </li>
                        </ul>
                    </div>
