                ...
                {({ open, close }) => (
                    <React.Fragment>
                        ...
                        <MenuItems className="absolute top-full left-0 mt-1 w-52 rounded-xl border border-gray-200 bg-white p-1 shadow-lg z-[25] focus:outline-none">
                            <MenuItem as="button" onClick={onClickEdit} className="group flex w-full items-center gap-2 rounded-lg px-3 py-1.5 text-gray-500">
                                {({ active }) => (
                                    <React.Fragment>
                            ...
                            <MenuItem as="button" onClick={onClickExit} className="group flex w-full items-center gap-2 rounded-lg px-3 py-1.5 text-gray-500">
                                {({ active }) => (
                                    <React.Fragment>
